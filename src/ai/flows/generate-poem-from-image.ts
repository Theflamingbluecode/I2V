'use server';
/**
 * @fileOverview AI flow to generate a poem from an image.
 *
 * - generatePoemFromImage - A function that generates a poem based on an image.
...
const GeneratePoemFromImageOutputSchema = z.object({
  poem: z.string().describe('The generated poem from the image.'),
});
...
const prompt = ai.definePrompt({
  ...
  Write a poem that captures the essence and emotions of the image.
